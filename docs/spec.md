...
2. プログラマー倫理マップを表示する
3. 画面上にollamaへの接続状態インジケーターを表示する
...
6. (生成AIが利用可能な場合) ポイント配分が変わるたびに自動的に倫理綱領テキストを生成し、日本語で表示する。生成中はローディング表示を行う
...
- レベルなし
  - P: 利益優先
    - 個人、組織、あるいは顧客の利益がすべてに優先する。
- レベル0
  - N0: 倫理的考慮
    - 個人、組織、あるいは顧客の利益に優先するものごとがある。
- レベル1
  - N1-1: 安全性
    - システムが誤作動せず、ユーザーのデータや資産を壊さないこと。
  - N1-2: ユーザー尊重
    - ユーザーが迷ったり間違えたりせず、自分の意思で操作できること。ユーザーを意図的に騙したりもしないこと (ダークパターンを避ける)。
  - N1-3: データ保護
    - ユーザーから預かったデータを外部に漏らしたり、内部で盗み見たりしない。情報セキュリティの3要素 (CIA＝機密性・完全性・可用性) を守る。
- レベル2
  - N2-1: 公平
    - その「安全性」が、特定の属性の人だけでなく、全員に対してバグなく、偏りなく動作すること。バイアスの除去。
  - N2-2: 公益
    - 社会全体や環境に対しても害を与えないこと。世界中のすべての人々、将来の世代のことまで考慮すること。
  - N2-3: 多様性
    - 障害を持つ人や高齢者など、多様な身体的条件を持つ人が操作権を行使できること。アクセシビリティを提供する。
  - N2-4: 基本的人権
    - デジタル空間へのアクセスを権利として保障すること。
  - N2-5: 透明性
    - データをどう使っているか正直に開示する。ブラックボックス化しない。
  - N2-6: 民主主義
    - 情報操作や監視によって、社会の意思決定プロセスを歪めないこと。法を犯して不当な利益を得ないこと。
