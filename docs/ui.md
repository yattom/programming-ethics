...
ブランチごとに色相を統一し、レベル差でパステル (レベル1) ↔ ビビッド (レベル2) を分ける。同じ親を持つレベル2の2ノードは、同じ色相ファミリーだが異なるトーンで区別する。

3色はトライアド (色相環上で120°等間隔) を採用する。マップ上のレベル1ノードの配置 (12時・4時・8時 = 120°間隔) と対応させる。

| ノード | 色 |
|--------|-----|
| P      | ウォームグレー (固定) |
| N0     | 淡いゴールド (中心・全ブランチの根) |
| N1-1   | 淡いオレンジ |
| N2-1   | ビビッドオレンジ |
| N2-2   | ビビッドアンバー |
| N1-2   | 淡いグリーン |
